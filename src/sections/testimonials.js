...
const TESTIMONIALS_DATA = [
  {
    image: img1,
    heading: 'Don Revolvedor',
    designation: 'Sitio Web',
    content:
      'El equipo de ROK es muy eficiente en la creación de sitios web y el mantenimiento de los mismos. Siempre están dispuestos a ayudar y resolver cualquier problema rápidamente. Además, su trabajo ha mejorado significativamente la performance, los números de la empresa y la visibilidad en línea.',
  },
  // {
  //   image: img2,
  ...
  //   content:
  //     'Desde que comencé a trabajar con ROK, mi sitio web ha funcionado sin problemas y ha sido actualizado con frecuencia para mantenerse al día. ',
  // },
  // {
  //   image: img3,
  //   heading: 'Ece Akman',
  ...
  //   content:
  //     'ROK ha sido un gran apoyo para mi negocio en línea. Han creado un sitio web atractivo y fácil de usar, y su mantenimiento ha sido excelente. Estoy muy satisfecho con los resultados,',
  // },
  // {
  //   image: img2,
  //   heading: 'Natalia Sanz',
