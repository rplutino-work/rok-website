          ...
          <Flex sx={styles.col}>
            <Box sx={styles.content}>
              <Box sx={styles.titleBox}>
                <Heading as="h3">
                Eleva tu negocio a nuevos niveles con nuestro apoyo
                </Heading>
                <Text as="p">
                Tres razones por las que debes elegirnos:
                </Text>
              </Box>
              <Box as="ul" sx={styles.list}>
                <Text as="li">
                  <IoIosCheckmarkCircle />
                  Una amplia selección de diseños modernos
                </Text>
                <Text as="li">
                  <IoIosCheckmarkCircle />
                  Tu sitio en menos de una semana.
                </Text>
                <Text as="li">
                  <IoIosCheckmarkCircle />
                  Precios competitivos y un servicio de alta calidad
                </Text>
              </Box>
