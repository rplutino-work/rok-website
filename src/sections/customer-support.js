        ...
        <Grid sx={styles.row}>
          <Box sx={styles.col}>
            <Box sx={styles.content}>
              <Heading as="h3">
                Las mejoras nunca paran!
              </Heading>
              <Text as="p">
                Siempre que desarrolles un sitio web con nosotros, tendrás acceso a un paquete mensual de horas dedicado para ajustes, mejoras y nuevas ideas para tu sitio web. Juntos, lo mantendremos siempre al máximo nivel de rendimiento y eficacia.
              </Text>
              <Text as="p" sx={styles.specialText}>
                Si queres saber mas al respecto y como funcionan los paquetes, hace click en el siguiente enlace.
              </Text>
              <Link path="/" sx={styles.link}>
                Saber más <FaAngleRight />
              </Link>
            </Box>
          </Box>
          <Box sx={styles.col}>
